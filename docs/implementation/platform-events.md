...
1. Crea Azure Function App (vedi [Implementazione Azure Function](azure-function.md))
...
- Usa **Private Endpoints** per sicurezza (vedi [Network e Sicurezza](network-sicurezza.md))
...
- [Implementazione Azure Function](azure-function.md)
- [Network e Sicurezza](network-sicurezza.md)
