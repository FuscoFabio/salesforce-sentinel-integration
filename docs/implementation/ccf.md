...
3. Aggiungi i range IP di Azure Cloud per la tua regione
   - Vedi [Gestione Network e Sicurezza](network-sicurezza.md) per dettagli
...
**Prossimi Passi:**
- [Configurare Query KQL avanzate](kql-queries.md)
- [Gestire Network e Sicurezza](network-sicurezza.md)
